...
export class CoCActor extends Actor {
  ...
  static hpFromCharacteristics (characteristics, type) {
    if (characteristics.con.value != null && characteristics.con.value != undefined) {
      return Math.floor(parseInt(characteristics.con.value)/2.5)
    } else {
      return(10)
    }
    //const sum = parseInt(characteristics.con.value ?? 0, 10)
